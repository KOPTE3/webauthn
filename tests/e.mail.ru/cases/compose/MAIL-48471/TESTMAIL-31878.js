...
let fastanswerSteps = new FastanswerSteps();
...
describe('AJAX. Ответ на письмо. Забытое вложение. Проверить отсутствие попапа для ' +
	'полного ответа с текстом в теле письма, с аттачем', () => {
	before(() => {
		Compose.auth();
	});
