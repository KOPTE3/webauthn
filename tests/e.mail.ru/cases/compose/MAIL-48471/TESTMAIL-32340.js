...
describe('TESTMAIL-32340: НЕ AJAX. Шаблоны. Забытое вложение. ' +
	'Проверить отсутствие попапа при отправке из шаблона ' +
	'(текст для которого попап появляться не должен)', done => {
	before(() => {
		Compose.auth();
	});
