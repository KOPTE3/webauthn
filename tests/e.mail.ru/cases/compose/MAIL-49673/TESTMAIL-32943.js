...
let { options = {
	name: 'Написание письма. Имена файлов в теме письма. Проверка, что если сами ' +
	'отредактировали тему, то при добавлении файла, его имя не добавляется в тему письма'
}} = module.parent;
