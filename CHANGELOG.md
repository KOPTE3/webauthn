# Changelog
## 9.16
* Добавили апишные методы для клинмастера, для имитации оплаты
* Добавили города для тестирования личных настроек и профиля на id.mail.ru
* Добавили фиксированные коды у телефонов
* Поправлены ссылки на спеку по webauthn-у

## 9.15
* Добавили тестовые методы SWA
* Починили метод с добавлением тестовой подписки на пуши
...
## 9.13.5
* Исправлен CAPTCHA_CRACKER_URL в конфиге

## 9.13.4
* Добавлены новые методы api
* Исправлены баги в авторизации и работе с mail-api методами

## 9.12.0
* Версия ts 3.6.3, поправлены тайпинги

## 9.11.0
* Добавлены методы для добавления ключей WebAuthn
* Добавлен тстовый метод для включения на аккаунте входа/восстановления через пуш
* Перенесли @qa/rpc в йоду


## 9.10.3
* Добавлены методы для добавления сборщиков

## 9.10.2
* В зависимости добавлены chromedriver и webdriverio
* Изменен адрес сервиса для авторизации ящиками test_login
